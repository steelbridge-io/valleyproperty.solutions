    ...
    <section id="banner" className="major">
        <div className="inner">
            ...
            <div className="content">
                <p className="lead">Valley Property Solutions, LLC is a residential redevelopment company that purchases homes in "as-is" condition. We make cash offers and can close in as little as 14 days. We purchase distressed/outdated properties at a discount and then force appreciation by renovating the home. Once remodeled, we then sell the house at its appropriate price to a new homeowner/landlord.</p>
