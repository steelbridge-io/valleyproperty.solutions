...
const saveState = () => {
  ...
  const pickedState = _lodash.default.pick(state, [`nodes`, `status`, `componentDataDependencies`, `components`, `staticQueryComponents`, `webpackCompilationHash`, `pageDataStats`]);
