...
const determineUsedFragmentsForDefinition = (definition, definitionsByName, fragmentsUsedByFragment) => {
  const {
    def,
    name,
    isFragment,
    ...
    visit(def, {
      [Kind.FRAGMENT_SPREAD]: node => {
        ...
        if (fragmentDefinition) {
          ...
          } = determineUsedFragmentsForDefinition(fragmentDefinition, definitionsByName, fragmentsUsedByFragment);
