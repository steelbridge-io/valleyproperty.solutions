...
exports.getProgressBar = () => progressBar; // Bound action creators should be set when passed to onPreInit in gatsby-node.
...
function prepareQueue({
  ...
  const {
    pathPrefix
        ...
        options = (0, _objectWithoutPropertiesLoose2.default)(args, ["pathPrefix"]);
  ...
  let aspectRatio = dimensions.width / dimensions.height; // If the width/height are both set, we're cropping so just return
  // that.
...
function createJob(job, {
  ...
  progressBar.total = pendingImagesCounter; // Jobs can be duplicates and usually are long running tasks.
